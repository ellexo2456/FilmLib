...
func (_m *ActorsRepository) Delete(id int) error {
	ret := _m.Called(id)
...
// Insert provides a mock function with given fields: actor
func (_m *ActorsRepository) Insert(actor domain.Actor) (int, error) {
	ret := _m.Called(actor)
...
func (_m *ActorsRepository) SelectAll() ([]domain.Actor, error) {
	ret := _m.Called()
...
func (_m *ActorsRepository) SelectById(id int) (domain.Actor, error) {
	ret := _m.Called(id)
...
func (_m *ActorsRepository) Update(actor domain.Actor) (domain.Actor, error) {
	ret := _m.Called(actor)
